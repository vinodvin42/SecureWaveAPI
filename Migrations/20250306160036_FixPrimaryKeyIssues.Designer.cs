...
namespace SecureWaveAPI.Migrations
{
    ...
    [Migration("20250306160036_FixPrimaryKeyIssues")]
    partial class FixPrimaryKeyIssues
    {
            ...
            modelBuilder.Entity("SecureWave.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("1fd78523-3938-4d0f-96c5-03b8bf9e81c0"),
                            Description = "Administrator role with full access",
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e92a8c42-02bc-4144-a569-478e1b1755da"),
                            Description = "Auditor role with read-only access",
                            RoleName = "Auditor"
                        },
                        new
                        {
                            RoleId = new Guid("42fc0472-025a-49de-8458-ed4a9ba78271"),
            ...
            modelBuilder.Entity("SecureWave.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("4c48ab63-28bb-4ce5-bffe-d39cd585c2e0"),
                            AccessJustification = "System Administrator",
                            AccessLevel = "Admin",
                            CreatedAt = new DateTime(2025, 3, 6, 16, 0, 35, 728, DateTimeKind.Utc).AddTicks(4275),
                            ...
                            PasswordHash = "okzW79VqZ9xawTK7LpjCvw==:J5N/No6A7yhK3j9Qydup6meih5lXOoTiAnuoQeIww/A=",
                            RecoveryToken = "",
                            RequiresMFA = false,
                            Username = "admin"
                        });
